...
with open('Channel_1_700nm_0.03.txt', 'r') as read_obj:
    csv_reader = reader(read_obj)
    for row in csv_reader:
        row = row[0].split(';')
        Ch1_U_mV.append(row[0])

with open('Channel_2_700nm_0.03.txt', 'r') as read_obj:
    csv_reader = reader(read_obj)
    for row in csv_reader:
        row = row[0].split(';')
...
plt.scatter(0.9310180830570873, 0.025601665479920183, label="optimal point at R=" + str(0.93101), color="0")
plt.scatter(0.9292763162161036, 0.0007919077718390034, label="Rmin=" + str(0.92927), color="y", zorder=2)
plt.scatter(0.932759849898071, 0.0015968486123770773, label="Rmax=" + str(0.93275), color="y", zorder=2)
plt.legend()
plt.xlabel('R')
plt.ylabel('Jaccard')
...
if PlotRegressionIsNeeded:
    ...
    ax.plot(ind, regression1, label="Regression 1", color="black")
    ...
    ax.plot(ind, regression2, label="Regression 2", color="black")
